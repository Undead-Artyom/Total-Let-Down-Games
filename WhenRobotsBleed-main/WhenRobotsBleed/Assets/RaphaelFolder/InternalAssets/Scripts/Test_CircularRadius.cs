...
public class Test_CircularRadius : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collider){
        ...
        {
            AddGrapplePoint(ref collider, ref _closestGrapplePointName, ref _closestGrappleDistance, ref _closestGrapplePointLocation, ref _dictionaryOfInRangeGrapplePoints);
        }
    }
    void OnTriggerExit2D(Collider2D collider){
        if(collider.gameObject.tag == "GrapplePoint")
        {
            RemoveGrapplePoint(ref collider, ref _closestGrapplePointName, ref _closestGrappleDistance, ref _closestGrapplePointLocation, ref _dictionaryOfInRangeGrapplePoints);
        }
    }
    void Start()
    {
    ...
    void Update()
    {
        UpdateClosestGrapplePoint(ref _closestGrapplePointName, ref _closestGrappleDistance, ref _closestGrapplePointLocation, ref _dictionaryOfInRangeGrapplePoints);
    }
    void OnDrawGizmos(){
